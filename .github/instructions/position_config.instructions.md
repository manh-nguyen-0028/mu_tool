...
- **Cách xác định thay đổi**: So sánh file `position_config_example.json` giữa version hiện tại và version main đó bằng git diff
  - Xác định branch/tag hiện tại (ví dụ: `update/v1.20`)
  - So sánh với version main bằng lệnh:
    ```
    git diff main..update/v1.20 -- config/json/change/position_config_example.json
    ```
